...
import sys
import os
from instruments.instrument_updater import download_and_split_instruments

sys.path.append(os.path.dirname(__file__))   # ← keeps imports working

from auth.auth_manager import load_credentials, save_access_token, is_token_valid, get_access_token
